...
import static cas_project.PC.photo;
...
public class snap extends javax.swing.JFrame {
    ...
    static {
        File file = new File("C:\\Users\\NEW\\Documents\\NetBeansProjects\\CAS_Project\\src\\imageDrivers\\opencv_java249.dll");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (option == 0) {
            try {
                ...
                int imageNo = 1 + RAND.nextInt(9999);
                ...
                PC.jTextField8.setText(Filename);
    ...
    private void CaptureImage(JLabel image) {
        try {
            ...
            if (getImage != null) {
                ...
                ImageIcon imageico = new ImageIcon(new ImageIcon(Filename).getImage().getScaledInstance(PC.jLabel14.getWidth(), PC.jLabel14.getHeight(), Image.SCALE_DEFAULT));
                PC.jLabel14.setIcon(imageico);
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(rootPane, "Warning");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(snap.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
